 ...
 * Retrieves and renders transactions for the authenticated user.
 *
 * @param {Object} req - Express request object.
 * @param {Object} req.userId - The ID of the authenticated user.
 * @param {Object} res - Express response object.
 * @returns {void} Renders the index page with transactions or sends an error response.
 */
